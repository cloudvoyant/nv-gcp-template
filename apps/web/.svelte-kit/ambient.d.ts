...
declare module '$env/static/private' {
	...
	export const GCP_DEVOPS_PROJECT_ID: string;
	...
	export const GCP_DEVOPS_PROJECT_REGION: string;
	...
	export const GCP_DEVOPS_DOCKER_REGISTRY_NAME: string;
	...
	export const GCP_DEVOPS_REGISTRY_NAME: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		DIRENV_DIR: string;
		WINDOWID: string;
		GCP_DEVOPS_PROJECT_REGION: string;
		...
		PWD: string;
		GCP_REGION: string;
		GCP_DEVOPS_DOCKER_REGISTRY_NAME: string;
		npm_command: string;
		EDITOR: string;
		...
		GCP_DEVOPS_REGISTRY_NAME: string;
		LESS: string;
		LOGNAME: string;
